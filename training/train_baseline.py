...
def plot_curves(history: dict, out_path: str):
    ...
    axes[0].set_title("Baseline Student — Accuracy", fontweight="bold")
    ...
    axes[1].set_title("Baseline Student — Loss", fontweight="bold")
...
def train():
    ...
    log_path = "outputs/logs/baseline_log.csv"
    ...
    plot_curves(history, "outputs/figures/baseline_curves.png")
